        ...
        <nav class="sm:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-200 shadow-[0_-2px_5px_rgba(0,0,0,0.05)]">
            <div class="max-w-7xl mx-auto px-4">
                <div class="flex justify-around h-16 items-center">
                    ...
                    @else
                    <a href="{{ route('login') }}" class="flex flex-col items-center justify-center text-center px-3 transition-colors duration-200 {{ request()->routeIs('login') ? 'text-indigo-600' : 'text-gray-500 hover:text-indigo-600' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
